...
```
/csiq-scaffold-batch
/csiq-scaffold-batch --name LeadCleanup --object Lead --scope 200
/csiq-scaffold-batch --name AccountSync --object Account --stateful --callouts --scope 50
/csiq-scaffold-batch --name CaseArchive --object Case --schedule "0 0 0 * * ?"
```
