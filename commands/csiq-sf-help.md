...
```
/csiq-sf-help deploy my code to production
/csiq-sf-help how to run all tests in my org
/csiq-sf-help create a scratch org
/csiq-sf-help export account data as CSV
/csiq-sf-help check my org's API usage limits
/csiq-sf-help retrieve metadata from my sandbox
```
