...
```
/csiq-code-review
/csiq-code-review --path force-app/main/default/classes/AccountService.cls
/csiq-code-review --severity High --domain security
/csiq-code-review --path force-app/main/default/lwc/accountList
```
