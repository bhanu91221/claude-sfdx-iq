...
- If code coverage data is unavailable, suggest running tests first with `/csiq-test`
...
```
/csiq-org-health
/csiq-org-health --target-org myProductionOrg
/csiq-org-health --section security,coverage
/csiq-org-health --threshold high --output health-report.md
```
