...
```
/csiq-scaffold-trigger
/csiq-scaffold-trigger --object Account --events beforeInsert,afterInsert,afterUpdate
/csiq-scaffold-trigger --object Custom_Object__c
/csiq-scaffold-trigger --object Order --framework TriggerHandler
```
