...
```
/csiq-test-data
/csiq-test-data --objects Account,Contact,Opportunity,Custom_Object__c
/csiq-test-data --objects Case,CaseComment --bulk-size 500
/csiq-test-data --objects Account,Contact --with-relationships
```
