...
```
/csiq-data-model
/csiq-data-model --mode analyze --objects Account,Contact,Opportunity,Custom__c
/csiq-data-model --mode design
/csiq-data-model --mode analyze --target-org myOrg --include-standard
```
