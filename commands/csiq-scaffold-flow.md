...
```
/csiq-scaffold-flow
/csiq-scaffold-flow --type Record-Triggered --object Case --trigger create,update
/csiq-scaffold-flow --type Screen --object Opportunity
/csiq-scaffold-flow --type Scheduled --object Lead
```
