...
/csiq-explain-error "System.LimitException: Too many SOQL queries: 101"
/csiq-explain-error "FIELD_CUSTOM_VALIDATION_EXCEPTION: [Status__c: You cannot change status without approval]"
/csiq-explain-error --error "System.NullPointerException: Attempt to de-reference a null object" --context AccountService.cls
```
