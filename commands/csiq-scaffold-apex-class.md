...
```
/csiq-scaffold-apex-class InvoiceService --type service --object Invoice__c
/csiq-scaffold-apex-class AccountSelector --type selector --object Account
```
