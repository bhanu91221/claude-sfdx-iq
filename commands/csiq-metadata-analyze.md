...
```
/csiq-metadata-analyze
/csiq-metadata-analyze --path force-app/main/default/classes/AccountService.cls
/csiq-metadata-analyze --deployment
/csiq-metadata-analyze --unused --type classes
/csiq-metadata-analyze --path force-app/main/default/objects/Account
```
