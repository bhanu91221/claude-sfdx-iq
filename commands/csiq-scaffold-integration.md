...
```
/csiq-scaffold-integration
/csiq-scaffold-integration --name Stripe --endpoint https://api.stripe.com/v1 --methods GET,POST
/csiq-scaffold-integration --name InternalERP --auth NamedCredential --format JSON
/csiq-scaffold-integration --name Twilio --methods POST --endpoint https://api.twilio.com/2010-04-01
```
