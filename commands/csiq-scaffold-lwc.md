...
```
/csiq-scaffold-lwc
/csiq-scaffold-lwc --name accountList --targets lightning__RecordPage --object Account --wire
/csiq-scaffold-lwc --name contactForm --apex ContactController
/csiq-scaffold-lwc --name dashboardWidget --targets lightning__AppPage,lightning__HomePage
```
